...
if __name__ == "__main__":
    ...
    while True:
        ...
        if poacher:
            cv2.putText(frame, "Intruder Detected", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
        else:
            cv2.putText(frame, "No Intruder Detected", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
